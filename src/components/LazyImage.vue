...
const currentElement = useCurrentElement<HTMLUListElement>();
...
useIntersectionObserver(currentElement, (entries): void => {
...
<template>
  <img
    ...
    :srcset="srcsetImage"
    v-bind="{ ...attrs }"
    :class="[attrs.class, , { 'image-loaded': loaded, intersected: intersected }]"
    @load="onLoad"
    @rror="onError" />
</template>
